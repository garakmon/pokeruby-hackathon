...
#define FESTIVAL_MONS_START 349

#define FESTIVAL_MON_POLITOED  (FESTIVAL_MONS_START + 0)
#define FESTIVAL_MON_POLITOED_MED  (FESTIVAL_MONS_START + 1)
#define FESTIVAL_MON_POLITOED_HIGH (FESTIVAL_MONS_START + 2)
#define FESTIVAL_MON_WALREIN       (FESTIVAL_MONS_START + 3)
#define FESTIVAL_MON_MEDICHAM (FESTIVAL_MONS_START + 4)
#define FESTIVAL_MON_SWALOT (FESTIVAL_MONS_START + 5)
#define FESTIVAL_MON_CLOYSTER (FESTIVAL_MONS_START + 6)
#define FESTIVAL_MON_LUGIA (FESTIVAL_MONS_START + 7)
#define FESTIVAL_MON_MAWILE (FESTIVAL_MONS_START + 8)
#define FESTIVAL_MON_SLAKING (FESTIVAL_MONS_START + 9)
#define FESTIVAL_MON_KANGASKHAN (FESTIVAL_MONS_START + 10)
#define FESTIVAL_MON_TAUROS (FESTIVAL_MONS_START + 11)
#define FESTIVAL_MON_PIDGEOT (FESTIVAL_MONS_START + 12)
#define FESTIVAL_MON_WIGGLYTUFF (FESTIVAL_MONS_START + 13)
#define FESTIVAL_MON_CHARIZARD (FESTIVAL_MONS_START + 14)
#define FESTIVAL_MON_HO_OH (FESTIVAL_MONS_START + 15)
#define FESTIVAL_MON_OCTILLERY (FESTIVAL_MONS_START + 16)
#define FESTIVAL_MON_CAMERUPT (FESTIVAL_MONS_START + 17)
#define FESTIVAL_MON_ARTICUNO (FESTIVAL_MONS_START + 18)
#define FESTIVAL_MON_SHARPEDO (FESTIVAL_MONS_START + 19)
#define FESTIVAL_MON_MEWTWO (FESTIVAL_MONS_START + 20)
// (FESTIVAL_MONS_START + )
// (FESTIVAL_MONS_START + )
// (FESTIVAL_MONS_START + )
// (FESTIVAL_MONS_START + )
